					...
					<FormSection title="Profile Details" icon={<FiInfo size={14} />}>
						<div className="space-y-2">
							...
							<select
								...
								className="w-full rounded-lg border border-slate-200 bg-white px-4 py-3.5 text-sm text-slate-900 outline-none"
							>
						...
						<div className="space-y-2">
							...
							>
								<span className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-blue-100 text-blue-600">
									{profileImageName ? <FiImage size={22} /> : <FiUploadCloud size={22} />}
								</span>
